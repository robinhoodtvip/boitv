...
def CheckUpdate(): #200
	try:
		uversao = urllib2.urlopen( "https://raw.githubusercontent.com/robinhoodtvip/boitv/master/versao.py" ).read().replace('\n','').replace('\r','')
...
def Update():
	...
	try:
		fonte = urllib2.urlopen( "https://raw.githubusercontent.com/robinhoodtvip/boitv/master/default.py" ).read().replace('\n','')
